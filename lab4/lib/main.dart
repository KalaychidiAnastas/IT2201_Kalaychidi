        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('Краснодар, ул. имени Калинина, 13'),
              trailing: Row(
                ...
                Column(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        _launchURL('https://yandex.ru/maps/org/obshchezhitiye_20/87985623421/?ll=38.920741%2C45.050329&z=7'); // Замените на нужный номер
                      },
                    ),
                    Text('Позвонить'),
                  ],
                ...
                Column(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        _launchURL('https://yandex.ru/maps/org/obshchezhitiye_20/87985623421/?ll=38.920741%2C45.050329&z=7'); // Замените на нужный URL
                      },
                    ),
                    Text('Маршрут'),
                  ],
